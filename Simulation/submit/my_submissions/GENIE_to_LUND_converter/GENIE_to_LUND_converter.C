...
// Include libraries:
#include "/w/hallb-scshelf2102/clas12/asportes/2N-Analyzer-e4nu/framework/namespaces/gemc/targets.h"
...
void GENIE_to_LUND_converter(TString InputFiles = "", /* TString OutputTopDir = "", */ /* TString outputFile = "", */ int nFiles = 1000, string target = "liquid", int A = 1, int Z = 1) {
    ...
    TString OutputTopDir = OutputFileBase + "/" + target_element + "/" + genie_tune + "/" + beam_e + "_" + Q2_cut + ending + "_Ar40_target_zpos_test_LATEST";

...
echo "${PRINT_OUT_COLOR}Number of mchipo files in target directory:\t\t\t\033[0m `ls ${OUTPATH}/mchipo | wc -l`"
echo "${PRINT_OUT_COLOR}Number of reconhipo files in target directory:\t\t\033[0m `ls ${OUTPATH}/reconhipo | wc -l`"
echo

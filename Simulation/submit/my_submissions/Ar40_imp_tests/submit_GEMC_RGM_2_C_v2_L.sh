...
#SBATCH --job-name=RGM_2_C_v2_L_sample_4GeV_test_14_5_11
#### #SBATCH --job-name=RGM_2_C_v2_L_sample_4GeV_test_13
...
OUTPATH=/lustre24/expphy/volatile/clas12/asportes/2N_Analysis_Reco/2N_Analysis_Reco_Samples/C12/G18_10a_00_000/4029MeV/def_Q2_th_L_5_11
...
GCARD=${SUBMIT_SCRIPT_DIR}/rgm_fall2021_RGM_2_C_v2_L.gcard
echo "GCARD = ${GCARD}"

...
void ConvertGENIE_Q2() {
    ...
    if (target == "C12") {
        ...
        BEAM_E = "4029MeV";  // 5986MeV_Q2_0_4_th
    }
    // if (target == "C12") {
    //     BEAM_E = "4029MeV";  // 4029MeV_def_Q2_th
    // } else if (target == "Ar40") {
    ...
    TString TRUTH_SAMPLE_ROOT_FILE_PREFIX = TARGET + "_" + GENIE_TUNE + "_Q2_0_19_" + BEAM_E;
    ...
    TString RECO_SAMPLE_OUTPUT_DIR = RECO_SAMPLES_TOPDIR + "/" + TARGET + "/" + GENIE_TUNE + "/" + BEAM_E;
    ...
    cout << "RECO_SAMPLE_OUTPUT_DIR = " << RECO_SAMPLE_OUTPUT_DIR << "\n\n";

    if (beam_e == "4029MeV") {
        GENIE_to_LUND_Q2(TARGET, GENIE_TUNE, BEAM_E, (TRUTH_SAMPLE_INPUT_DIR + "/" + RECO_SAMPLES_SUBDIR + "/" + TRUTH_SAMPLE_ROOT_FILE), RECO_SAMPLE_OUTPUT_DIR,
                         TRUTH_SAMPLE_ROOT_FILE_PREFIX, NUM_OF_FILES, TARGET_TYPE, TARGET_A, TARGET_Z,
                         0.19,   // start (4029MeV_def_Q2_th)
                         10,    // finish (4029MeV_def_Q2_th)
                         10);  // delta (4029MeV_def_Q2_th)

...
#SBATCH --job-name=mc_c12_598636MeV_Q2_0_4_test_2_num_1
...
NEVENTS=10000
TORUS=-1.0
FILE_PREFIX=c12_598636MeV_Q2_0_4 #Change file prefix for your simulation
...
recon-util -y $YAML -i /lustre19/expphy/volatile/clas12/asportes/simulationFiles/598636MeV_Q2_0_4_test_2/mchipo/mc_${FILE_PREFIX}_${SLURM_ARRAY_TASK_ID}_torus${TORUS}.hipo -o /lustre19/expphy/volatile/clas12/asportes/simulationFiles/598636MeV_Q2_0_4_test_2//reconhipo/recon_${FILE_PREFIX}_${SLURM_ARRAY_TASK_ID}_torus${TORUS}.hipo
